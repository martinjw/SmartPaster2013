...
namespace SmartPaster_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new SmartPasterPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(SmartPaster.GuidList.guidSmartPasterCmdSet, (int)SmartPaster.PkgCmdIDList.cmdidPasteAsComment);
